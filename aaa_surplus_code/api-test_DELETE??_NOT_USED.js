...
(function(){
   ...
   function testAPIs(){
    // test list first
    console.log('PUBLIC/JS/api.js LINE 8:   \n\n***************************\ncreate results:');
      ...
      .then(()=>{
        ...
        callAPI('POST', '/api/photos', null, data)
          ...
          .then((photo)=>{
            ...
            console.log("api-test.js  LINE 57:  photo = ", )
  ...
  //  afer validating that there's a file selected.
    ...
    document.addEventListener("DOMContentLoaded", () => {
      const button = document.querySelector("#testme");
      console.log(" PUBLIC/JS/api.js   LINE 128:   Found button:", button);
      button?.addEventListener("click", () => {
        console.log("✅ Button clicked! Running testAPIs...");
        testAPIs();
      });
    });
  ...
  //   let input = document.querySelector('input[type="file"]')
  //   if (input.value){ 
  //     console.log('PUBLIC/JS/api.js LINE 127:  TESTING:  prior to call to testAPIs');
  //     testAPIs();
  //   }else{
  //     alert("BRICKY please select an image file first");
  //   }
  // });
})();
